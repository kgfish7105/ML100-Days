...
--------------------------HW_41-----------------------
決策樹Decision Tree 有辦法把function loss降成0 (overfitting)

--------------------------HW_42-----------------------
決策樹Decision Tree 實作

--------------------------HW_43-----------------------
隨機森林Random forest中的每一棵樹，是希望能夠
...
--------------------------HW_47-----------------------
超參數調整過程
1.先把資料切成 train data(3/4)、 test data(1/4)
2.把train data 用Cross validation(避免使model依賴同一組train data，泛化) 分別套用在Grid search找最佳參數
3.統計每一輪cross validation的參數，選擇出現最多次數的那組參數
4.套用model在test data